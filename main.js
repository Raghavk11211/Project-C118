...
randomNumber = Math.floor(Math.random()*array_1.length+1);
...
function updateCanvas() {
    background("white");
    randomNo = Math.floor(Math.random(quick_draw_data_set));
    console.log(randomNo);
    document.getElementById("sketch_to_be_drawn").innerHTML = randomNo;
}
function setup() {
